...
public class PangCharacterTest {
    ...
    public void test_decrypt() throws IOException {
        ...
        assertEquals(262513, character.uniqueId());
    ...
    public void test_encrypt() {
        var pangCharacter = new PangCharacter(
                67108872,
                262513,
                2,
                new int[] {
